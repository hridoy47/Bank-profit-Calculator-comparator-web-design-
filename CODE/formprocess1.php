...
<hr>
<?php
$p1 = $_POST['FD_Ammount1(tk)'];
 $p2 = $_POST['FD_Ammount(tk)'];
 $p=$p1+$p2;
 switch($_POST['Compounding_Frequency'])
   {
	   case "Monthly" :
	        $n=12;
			break;
 ...
 $t1=$_POST['FD_Period1(in_Month)']/12;
 $t2= $_POST['FD_Period(in_Month)']/12;
 $t=$t1+$t2;
 $sql = "SELECT * FROM fdr ORDER BY FDR_interest DESC";
...
echo "<center><h1>ফিক্সড ডিপোজিট রিসিপ্ট হিসাবের ফলাফল</h1></center>";
