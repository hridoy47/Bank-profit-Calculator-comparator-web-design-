...
<?php
 $p1 = $_POST['DPS_Ammount1(tk)'];
$p2 = $_POST['DPS_Ammount2(tk)'];
 $p=$p1+$p2;
 $t1= $_POST['DPS_Period1(in_Month)']/12;
 $t2= $_POST['DPS_Period2(in_Month)']/12;
 $t=$t1+$t2;
 
 $sql = "SELECT * FROM dps ORDER BY DPS_interest DESC";
...
echo "<center><h1>ডিপোজিট পেনশন স্কিমের ফলাফল</h1></center>";
...
<div class="media">
 ...
 <div class="media-left"> <a href="#"> <img class="media-object" src="images/CSE_ad_logo_colors_text.gif" style="width:75px; height:75px"  alt="placeholder image"></a></div>
 <div class="media-body">
      <address>
